function [p] = defaultparamsCA1_tst0noise()
% possible input: current_gmax_ee
...
p.twE = 25;    % theta resonance, [=]ms; original val = 120
p.VtE = -50;    % ?
p.VrE = -46;    % ?
...
p.gnoiseE = 0; % coefficients for Ornstein-Uhlenbeck process
p.gnoiseI = 0; % 
...
p.Edc = 40; % input DC to relax f-I curve and allow low current inputs to generate output
p.jmpE = 210;
p.Idc = 180;
p.jmpI = 700;
