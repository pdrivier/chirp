function [p] = defaultparamsCA1_connEEincrease_gmaxEEsameasgmaxIEtimes4()
...
p.twE = 120;     % theta resonance, [=]ms; original val = 120
p.VtE = -50;    % ?
p.VrE = -46;    % ?
...
p.gmaxII = 3/(80/100);%1on1 syn strength /percent synch efficacy
p.gmaxEI = 2/(30/100);
p.gmaxIE = 5/(60/100);
p.gmaxEE = 4*(5/(60/100));%multiply by 4 to equalize mean conductance with IE
                          %which would otherwise get normalized to a
                          %smaller mean value in NetworkRunSeqt.m
