function [p] = defaultparamsCA1_weakPING03_hippobook()
...
p.tauEd = 3; % timescale decay %MOD: =tau_D,stoch,E? in book chapter
% EtoB
p.tauEIr = 0.9; 
...
p.gmaxII = 0.5; %3/(80/100)
p.gmaxEI = 0.5; %2/(30/100
p.gmaxIE = 1.5; %5/(60/100)
