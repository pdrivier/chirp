function [p] = defaultparamsCA1_connEEincrease_gmaxEdenom5()
...
p.gmaxII = 3/(80/100); % not sure where these vals come from
p.gmaxEI = 2/(30/100);
p.gmaxIE = 5/(60/100);
p.gmaxEE = p.gmaxEI/5; % original denominator = 10
%1on1 syn strength /percent synch efficacy
