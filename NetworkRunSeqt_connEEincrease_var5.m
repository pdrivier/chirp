function [conn,vbar,veg,lfp,tspE,tspI,Isynbar,inp,seqs]= NetworkRunSeqt_connEEincrease_gmaxEdenom5(p,input,NE,NI,T,opt)
...
GEE(GEE<0) = 0; % rectifies negative weights to 0
conn.EtoE = GEE; % aggregate connectivity matrices
